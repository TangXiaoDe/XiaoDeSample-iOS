...
//        AutoTaskTimeViewUtil.shared.hideMenu()
    }
...
extension XDWKWebViewController: WKNavigationDelegate {
    ...
    func webView(_ webView: WKWebView, didFinish navigation: WKNavigation!) {
        ...
        if self.duration != 0 {
            if !isComplete {
//                AutoTaskTimeViewUtil.shared.show(duration: self.duration, completeBlock: self.playCompleteBlock)
            } else {
//                AutoTaskTimeViewUtil.shared.show(duration: 0, completeBlock: self.playCompleteBlock)
            }
        }
