...
class LaunchGuideController: BaseViewController
{
    ...
    /// 引导页总数
    fileprivate let pageCount: Int = 4
...
extension LaunchGuideController {
...
extension LaunchGuideController: UIScrollViewDelegate {
