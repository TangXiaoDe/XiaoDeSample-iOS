...
protocol HorScroll52TitleViewProtocol: class {
    func titleView(_ titleView: HorScroll52TitleView, didClickedAt index: Int, with type: HorScrollListType) -> Void
}

typealias HorScroll52TitleSectionView = HorScroll52TitleView
class HorScroll52TitleView: UIView
{
    ...
    weak var delegate: HorScroll52TitleViewProtocol?
    var titleClickAction:((_ titleView: HorScroll52TitleView, _ index: Int, _ type: HorScrollListType) -> Void)?
...
extension HorScroll52TitleView {
    class func loadXib() -> HorScroll52TitleView? {
        return Bundle.main.loadNibNamed("HorScroll52TitleView", owner: nil, options: nil)?.first as? HorScroll52TitleView
    }
...
extension HorScroll52TitleView {
    ...
    fileprivate func setupScrollView(with types: [HorScrollListType]) -> Void {
        ...
        for (index, type) in self.types.enumerated() {
            ...
            button.bounds = CGRect.init(x: 0, y: 0, width: itemW, height: HorScroll52TitleView.viewHeight)
