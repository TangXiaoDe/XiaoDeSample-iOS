...
protocol HorScroll51TitleViewProtocol: class {
    func titleView(_ titleView: HorScroll51TitleView, didClickedAt index: Int, with type: HorScrollListType) -> Void
}

typealias HorScroll51TitleSectionView = HorScroll51TitleView
class HorScroll51TitleView: UIView
{
    ...
    weak var delegate: HorScroll51TitleViewProtocol?
    var titleClickAction:((_ titleView: HorScroll51TitleView, _ index: Int, _ type: HorScrollListType) -> Void)?
...
extension HorScroll51TitleView {
    class func loadXib() -> HorScroll51TitleView? {
        return Bundle.main.loadNibNamed("HorScroll51TitleView", owner: nil, options: nil)?.first as? HorScroll51TitleView
    }
...
extension HorScroll51TitleView {
    ...
    fileprivate func setupScrollView(with types: [HorScrollListType]) -> Void {
        ...
        for (index, type) in self.types.enumerated() {
            ...
            button.bounds = CGRect.init(x: 0, y: 0, width: itemW, height: HorScroll51TitleView.viewHeight)
