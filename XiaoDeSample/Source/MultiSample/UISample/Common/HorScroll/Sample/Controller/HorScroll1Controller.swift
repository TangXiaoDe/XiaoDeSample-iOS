//
//  HorScroll1Controller.swift
//  XiaoDeSample
//
//  Created by 小唐 on 2020/7/8.
//  Copyright © 2020 XiaoDeStudio. All rights reserved.
//
//  导航栏为UISegmentedControl方式多页滚动

import UIKit

class HorScroll1Controller: BaseViewController
{
    ...
    fileprivate let titleSegment: UISegmentedControl = UISegmentedControl(items: [HorScrollListType.follow.title, HorScrollListType.recommend.title, HorScrollListType.nearby.title])
...
extension HorScroll1Controller {
...
extension HorScroll1Controller: UIScrollViewDelegate {
