//
//  HorScroll52Controller.swift
//  XiaoDeSample
//
//  Created by 小唐 on 2020/7/8.
//  Copyright © 2020 XiaoDeStudio. All rights reserved.
//
//  HorScroll5中的左侧列表 - 我的订单

import UIKit

class HorScroll52Controller: BaseViewController
{
    ...
    fileprivate var types: [HorScrollListType] = [.all, .topay, .todeliver, .toreview, .done]
...
extension HorScroll52Controller {
...
extension HorScroll52Controller {
    ...
    fileprivate func initialUI() -> Void {
        ...
        // navigationBar
        self.navigationItem.title = "HorScroll52"
        // titleSecton
...
extension HorScroll52Controller: UIScrollViewDelegate {
...
extension HorScroll52Controller: HorScroll52TitleViewProtocol {
