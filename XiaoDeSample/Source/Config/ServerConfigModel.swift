...
class ServerConfigModel: Mappable {
    ...
    /// 商务联系数据模型
    var business: ServerBusinessContactModel?
    /// 退出天数(社群加入社区)
    var quitDay: Int = 0
    /// 红包限制
    var bonusLimit: ServerBonusLimitModel?
//    /// 注册协议
...
/// 商务联系方式数据模型
class ServerBusinessContactModel: Mappable {

    var qq: String = ""
    var email: String = ""
    var XiaoDeSample: String = ""
    var wechat: String = ""
...
/// 红包限制相关
class ServerBonusLimitModel: Mappable
{
